                            ...
                            <div key={idx} className="flex flex-col sm:flex-row items-center   gap-11">
                                ...
                                <div className="flex flex-col items-center sm:items-start gap-2   ">
                                    ...
                                    <div className="relative group/tooltip">
                                        ...
                                        <div class="i-fa-pro:bullseye-arrow text-emerald-700 dark:text-white">

                                        </div>
                                        </div>
                                        <span class="absolute pointer-events-none transition-all opacity-0 z-20 bottom-full -translate-y-0 py-1 px-1.5 text-xs left-1/2 -translate-x-1/2 rounded-md whitespace-nowrap text-gray-200 bg-gray-800 dark:bg-white dark:text-gray-700 before:content-[''] before:absolute before:bg-gray-800 before:rounded-sm before:w-2.5 before:rotate-45 before:h-2.5 before:-bottom-1 before:-z-10 before:left-1/2 before:-translate-x-1/2 before:dark:bg-white before:dark:gray-800 group-hover/tooltip:opacity-100 group-hover/tooltip:-translate-y-3">Disponible</span>
                                        </div>
