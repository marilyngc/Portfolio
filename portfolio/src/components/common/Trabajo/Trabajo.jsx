          ...
          <li className="mb-10 ms-4">
            ...
            <div className="first-of-type:mt-0 mt-5">
              ...
              <p className="my-3 text-base font-normal text-cAccent text-pretty">
                {" "}
                Trabajo como freelancer, creando interfaces de usuario atractivas y funcionales con HTML, CSS, JavaScript y React. Colaboro con el equipo de diseño. Mi objetivo es desarrollar aplicaciones web responsivas y centradas en el usuario.{" "}
              </p>{" "}
            </div>{" "}
          </li>
